...
public class MasterAPITest {
	...
	public void masterAPITest() {
		given()
			...
			.log().all()
			.when()
			.post("master")	//for post request default content type is getting added, hence we mark content-type as empty
			.then()
			.log().all()
			.statusCode(200)
			...
			.body("data.mst_oem.size()", Matchers.greaterThan(0))	//check the size of the JSON array
